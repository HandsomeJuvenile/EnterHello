...
public class TransactionGetTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        *//*
         * eth_call allows you to call a method on a smart CoinContract to query a value.
         * There is no transaction cost associated with this function,
         * this is because it does not change the state of any smart CoinContract method's called,
