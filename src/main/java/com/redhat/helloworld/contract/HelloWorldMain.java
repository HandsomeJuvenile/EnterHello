...
public class HelloWorldMain {
    ...
    public static void main(String[] args) throws Exception {
       ...
       /* Credentials credentials = WalletUtils.loadCredentials(Consts.PASSWORD, Consts.PATH);
        ...
        // 部署合约
        // HelloWorldContract CoinContract = HelloWorldContract.deploy(web3j, credentials,
        //         Consts.GAS_PRICE, Consts.GAS_LIMIT).send();
        // System.out.println("getContractAddress : " + CoinContract.getContractAddress());

        // 加载合约
        HelloWorldContract CoinContract = HelloWorldContract.load(Consts.HELLOWORLD_ADDR, web3j, credentials,
                Consts.GAS_PRICE, Consts.GAS_LIMIT);
        System.out.println("getContractAddress : " + CoinContract.getContractAddress());

        ////////// 同步请求方式 //////////
        // set
        TransactionReceipt transactionReceipt = CoinContract.set(10000).send();
        System.out.println("waiting..."); // 进入阻塞
        System.out.println("set : " + transactionReceipt.getTransactionHash());
        // get
        Uint256 result = CoinContract.get().send();
        System.out.println("waiting..."); // 进入阻塞
        ...
        // set
        *//*
        CompletableFuture<TransactionReceipt> transactionReceiptAsync = CoinContract.set(10000).sendAsync();
        System.out.println("waiting..."); // 马上返回
        System.out.println("set : " + transactionReceiptAsync.get().getTransactionHash());
        *//*
        // get
        *//*
        CompletableFuture<Uint256> resultAsync = CoinContract.get().sendAsync();
        System.out.println("waiting..."); // 马上返回
